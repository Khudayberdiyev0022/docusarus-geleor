      ...
      <div className={style.cardGroups}>
        <div className={style.leftBlock}>
          ...
          <div className={style.cardsInfo}>
            <div className={style.iconsBtn}>
              <span className={style.smallLines}></span>
            ...
            <p>
              Подберём и внедрим платформу управления ВМ с API: OpenStack,
              oVirt, OpenNebula;
            </p>
            <h5># Контейнеры</h5>
        ...
        <div className={style.rightBlock}>
          <div className={style.cardsInfo}>
            ...
            <p>
              Внедрим PostgreSQL, MySQL, Mongo, ClickHouse, Redis, RabbitMQ и
              т.д. с требуемым уровнем отказоустойчивости;
            </p>
            <h5># Поиск и устранение узких мест</h5>
            <p>
              Тестируем и повышаем производительность существующих сервисов;
            </p>
