    ...
    <div className={style.parts2}>
      ...
      <div className={style.cardGroups}>
        ...
        <div className={style.cardsInfo}>
          ...
          <h6># Программно-определяемое хранилище</h6>
          <p>Внедрим CEPH, LINSTOR на уже имеющимся или новом железе;</p>
          <h6># Логирование, мониторинг, оповещение</h6>
          <p>
        ...
        <div className={style.cardsInfo}>
          ...
          <h6># Снижение времени восстановления после аварий</h6>
          <p>Создаем и проверим DRP вашей инфраструктуры;</p>
          <h6># Аутсорсинг задач DevOps</h6>
          <p>
